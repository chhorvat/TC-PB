...
%
Ax{4} = subplot('position',[0.675 0.06 0.25 0.4]);
...
Ax{2} = subplot('position',[0.06 0.06 0.25 0.4]);
...
%
Ax{3} = subplot('position',[0.365 0.06 0.25 0.4]);
...
saveas(gcf,'/Users/chorvat/Dropbox (Brown)/Apps/Overleaf/AGU Geophysical Research Letters_Extreme_TC-PB/Figures/Fig-1.pdf');
saveas(gcf,'Fig-1.pdf'); 
saveas(gcf,'/Users/chorvat/Dropbox (Brown)/Apps/Overleaf/AGU Geophysical Research Letters_Extreme_TC-PB/Figures/Fig-1.jpeg');
